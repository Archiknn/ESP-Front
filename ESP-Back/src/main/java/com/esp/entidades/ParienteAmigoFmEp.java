...
@Entity
@Table(name = "pariente_amigo_fm_ep", schema = "ESP")
public class ParienteAmigoFmEp {
	...
	@Column(name = "organismo_entidad")
	private String organismoEntidad;
	@Column(name = "unidad")
	private String unidad;
	
	
	public ParienteAmigoFmEp() {
		
	}


	public ParienteAmigoFmEp(String numeroDocumento, String numeroDocumentoAspirante, String tipoDocumento,
			...
			int numeroTelefono, String organismoEntidad, String unidad) {
		super();
